    ...
    <aside id="sidebar" class="sidebar border-end">
      ...
      <div class="px-3 pb-3">
        ...
        <ul class="nav flex-column gap-1">
          ...
          <li class="nav-item"><a class="nav-link" href="#"><i class="bi bi-people me-2"></i>ลูกค้า/สัตว์เลี้ยง</a></li>
          <li class="nav-item"><a class="nav-link" href="#"><i class="bi bi-calendar-week me-2"></i>ปฏิทินนัดหมาย</a>
          </li>
          <li class="nav-item"><a class="nav-link" href="#"><i class="bi bi-bandaid me-2"></i>บริการ & แพ็คเกจ</a></li>
